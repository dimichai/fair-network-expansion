...
class StateCriticDynamic(nn.Module): # ststic+ dynamic + matrix present
    """Estimates the problem complexity.
    ...
    def __init__(self, dynamic_size, hidden_size, grid_size):
        super(StateCriticDynamic, self).__init__()
    ...
    def forward(self, dynamic, hidden_size, grid_x_size, grid_y_size):
        ...
        hidden = dynamic_hidden.unsqueeze(0)
